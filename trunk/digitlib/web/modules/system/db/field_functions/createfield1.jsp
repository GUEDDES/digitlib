...
{	
	 if(request.getParameter("fieldnb").equals("")){out.println("<script language='javascript'> window.alert('You must enter a number of fields!');self.location.href=document.referrer;</script>");}
	 else
	 {	 	
	 ...
	 out.println("<table bgcolor='#7fa5c8' width='100%'><tr><td align='center'><b>Field<b></td><td align='center'><b>Type</b></td><td align='center'><b>Extra*</b></td><td align='center'><b>Default</b></td><td align='center'><b>NotNull</b></td> <td align='center'><b>AutoIncrement</b></td> <td align='center'><b>Prim.Key</b></td></tr><form action='createfield2.jsp?t=local' method='post'><input type='hidden' name='nbfield' value='"+fieldnb+"'><input type='hidden' name='nametbl' value='"+tblname+"'><input type='hidden' name='db' value='"+request.getParameter("db")+"'>");

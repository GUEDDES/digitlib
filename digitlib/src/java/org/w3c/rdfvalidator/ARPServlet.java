/***********************************************************************
 *
 * ARPServlet - this servlet implements an RDF Validation service.
 ...
 *
 * $Id: ARPServlet.java,v 1.84 2007/12/31 06:52:03 ot Exp $
 *
 ***********************************************************************/
...
{
    final static public String	REVISION = "$Id: ARPServlet.java,v 1.84 2007/12/31 06:52:03 ot Exp $";
    ...
    private File createTempFile (String directory, String prefix, String suffix)
    {
        File f;
        try {
            File d = new File(getServletContext().getRealPath("/")+directory);

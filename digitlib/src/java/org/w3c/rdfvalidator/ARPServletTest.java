/***********************************************************************
 *
 * ARPServletTest - this servlet implements an RDF Validation service.
 * *** THIS CODE IS OBSOLETED BY:
 *            http://dev.w3.org/cvsweb/2006/RDFValidator/
 *     which is the code currently running at:
 ...
 *
 * $Id: ARPServletTest.java,v 1.84 2007/12/31 06:52:03 ot Exp $
 *
 ***********************************************************************/
...
public class ARPServletTest extends HttpServlet
{
    final static public String	REVISION = "$Id: ARPServletTest.java,v 1.84 2007/12/31 06:52:03 ot Exp $";
    ...
    // Servlet name
    private static final String SERVLET_NAME = "ARPServletTest";
...
// 		}
    ...
    private void printTripleTableHeader (PrintWriter out, boolean nTriples) 
    {
        try {
            if (nTriples) {
                ...
                out.println("<table cellspacing='0' cellpadding='2' frame='border' rules='all'><tr>" +
			    "<td><b>Number</b></td>" +
			    "<td><b>Subject</b></td>" +
			    "<td><b>Predicate</b></td>" +
			    "<td><b>Object</b></td>" +
	 ...
	 */
        ...
        {
	    if (!ARPServletTest.AT_LEAST_ONE_TRIPLE){ARPServletTest.AT_LEAST_ONE_TRIPLE=true;}
	    if (printTriples)
        ...
        public void printFirstPart(AResource subj) 
	{
		...
		if (gFormat!=null && gFormat.equals(FORMAT_ISV_ZVTM)){
		    this.pw.println("\"" + subj.getURI() + "\" [fontcolor=\""+Float.toString(ARPServletTest.resTBh)+","+Float.toString(ARPServletTest.resTBs)+","+Float.toString(ARPServletTest.resTBv)+"\",URL=\"" +subj.getURI() + "\"];");
		}
		else {
	 ...
	 */
		...
		if (this.anonNodesEmpty) {
		    if (gFormat!=null && gFormat.equals(FORMAT_ISV_ZVTM)){
			this.pw.println("\"" + ANON_NODE +obj.getAnonymousID() + "\" [fontcolor=\""+Float.toString(ARPServletTest.prpTh)+","+Float.toString(ARPServletTest.prpTs)+","+Float.toString(ARPServletTest.prpTv)+"\",label=\"" + pred.getURI() + "\",URL=\"" + pred.getURI() + "\"];");
		    }
		    else {
		...
		if (gFormat!=null && gFormat.equals(FORMAT_ISV_ZVTM)){
		    this.pw.println("\"" + obj.getURI() + "\" [fontcolor=\""+Float.toString(ARPServletTest.prpTh)+","+Float.toString(ARPServletTest.prpTs)+","+Float.toString(ARPServletTest.prpTv)+"\",label=\"" +pred.getURI() + "\",URL=\"" + pred.getURI() + "\"];");
	 ...
	 */
	    ...
	    if (gFormat!=null && gFormat.equals(FORMAT_ISV_ZVTM)){
		this.pw.println("\" [fontcolor=\""+Float.toString(ARPServletTest.prpTh)+","+Float.toString(ARPServletTest.prpTs)+","+Float.toString(ARPServletTest.prpTv)+"\",label=\"" + pred.getURI() + "\",URL=\""    + pred.getURI() + "\"];");

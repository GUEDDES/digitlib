...
try{
    ...
    if(request.getParameter("t")!=null) {
        ...
        out.println("<table border='0' width='90%'><h3>Field properties for table <font color='blue'> "+target+"</font> in database <font color='blue'> "+request.getParameter("db")+"</font></h3>");

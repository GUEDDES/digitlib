...
function execPrefQuery(){ 
    ...
    var xhr = getXhr();        
    // Ici on va voir comment faire du post
    xhr.open("POST","modules/resources/ajax/execAdecyg.jsp",true);
    // ne pas oublier ça pour le post
    xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
    // ne pas oublier de poster les arguments
    // ici, l'id de l'auteur
...
<div class="box1">
    <h1 align="center">Testing of the algorithm for the detection of cycles in a directed graph</h1>    
</div>
<div class="box1">      
...
<div id="result">
    <div class="box1"><h2>DigitLib help with testing :</h2>
        <div id="dlhelp">
